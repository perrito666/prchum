...
double-cliquer ; Apple Silicon, macOS 14+. Sous Linux, prenez l'archive
`prchum-gtk` au même endroit ; elle demande GTK 4.12 et libadwaita 1.5
ou plus récents. Ou compilez depuis les sources :
