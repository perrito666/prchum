...
ver de verdad. Las capturas usan la apariencia oscura y el tema
`default`; el repositorio en revisión es un pequeño generador de
jugadas de ajedrez, y quien revisa es `ada`.
...
![La pantalla de inicio](images/home.png)
...
![La cola de revisión](images/review-queue.png)
...
![El selector de filtros](images/queue-filters.png)
...
![Una ventana de revisión](images/review-window.png)
...
![Un pull request](images/pull-request.png)
...
![Información del pull request](images/pr-info.png)
...
![Vista dividida](images/split-view.png)
...
![Solo los hunks](images/hunk-view.png)
...
![Contexto de archivo completo](images/context-view.png)

## Comentar

⌘↩ comenta la línea bajo el cursor, o la selección.

![El compositor de comentarios](images/comment-composer.png)

Una selección de varias líneas se vuelve un comentario de rango, tal
como lo entiende la forja.

![Un comentario de varias líneas](images/multiline-comment.png)
...
![Un hilo de comentarios](images/comment.png)
...
![El navegador de revisión](images/navigator.png)
